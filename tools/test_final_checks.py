...
with sync_playwright() as pw:
    ...
    page.goto('http://127.0.0.1:8766/researcher');page.locator('#preview-link').wait_for()
    ...
    touch=mobile.new_page();touch.goto('http://127.0.0.1:8766/?SESSION_ID=QA-touch-'+str(time.time_ns()));touch.wait_for_function('window.buffet',timeout=90000)
    ...
    empty=browser.new_page(viewport={'width':1200,'height':800});empty.goto('http://127.0.0.1:8766/?condition=no_screenshot&SESSION_ID=QA-empty-'+str(time.time_ns()));empty.wait_for_function('window.buffet',timeout=90000)
